...
import com.example.letschat.Fragment.APIService;
import com.example.letschat.Model.Chat;
import com.example.letschat.Notifications.Client;
import com.example.letschat.Notifications.Data;
       ...
       // getSupportActionBar().setDisplayShowHomeEnabled(true);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(com.example.letschat.MessageActivity.this,UsefeedActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!msg.equals(""))
                    ...
                    Toast.makeText(com.example.letschat.MessageActivity.this,"You can't send",Toast.LENGTH_LONG).show();
                text_send.setText("");
                                ...
                                public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                    if(response.code()==200)
                                        if(response.body().success==1)
                                            Toast.makeText(com.example.letschat.MessageActivity.this,"Failed",Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1:snapshot.getChildren()) {
                    ...
                    messageAdapter=new MessageAdapter(com.example.letschat.MessageActivity.this,mchat,imageurl);
